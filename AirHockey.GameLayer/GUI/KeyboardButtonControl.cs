namespace AirHockey.GameLayer.GUI
{
    ...
    class KeyboardButtonControl : GUIControl
    {
        public delegate void ButtonClickHandler(KeyboardButtonControl sender, ButtonClickEventArgs e);
        ...
        public KeyboardButtonControl(int x, int y, int width, int height)
